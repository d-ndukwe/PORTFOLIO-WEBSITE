...
function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-slate-950 text-slate-100 z-50 border-b border-slate-800">
      <nav className="p-4 flex justify-between items-center max-w-6xl mx-auto">
        {/* LOGO */}
        <div className="text-xl font-bold">
          <Link to="/" onClick={closeMenu}>
            Divine <span className="text-teal-300">Ndukwe</span>
          </Link>
        </div>
        ...
        <div className="md:hidden flex items-center">
          <button 
            onClick={toggleMenu} 
            className="text-slate-100 hover:text-teal-300 focus:outline-none"
      ...
      {isOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-slate-900 border-b border-slate-800 animate-in slide-in-from-top duration-300">
          <ul className="flex flex-col items-center py-8 gap-6 text-lg font-medium">
            <li>
              <a href="/#about" onClick={closeMenu} className="hover:text-teal-300">About</a>
            </li>
            <li>
              <a href="/#projects" onClick={closeMenu} className="hover:text-teal-300">Projects</a>
            </li>
            <li>
              <a href="/#contact" onClick={closeMenu} className="hover:text-teal-300">Contact</a>
            </li>
          </ul>
        </div>
      )}

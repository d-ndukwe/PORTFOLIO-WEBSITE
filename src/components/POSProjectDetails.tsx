...
import { ArrowLeft, GitMerge, Layout, Smartphone, Zap } from "lucide-react";
import { Link } from 'react-router-dom';

const POSProjectDetails = () => {
  return (
      ...
      <header className="pt-24 pb-12 px-6 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            {["React", "Tailwind CSS", "Lucide Icons", "React Router", "Responsive Design"].map((tech) => (
        ...
        <section className="grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            ...
            <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
              SwiftPOS is a comprehensive Point of Sale and Inventory management system designed to streamline retail operations. 
              As the **Frontend Developer**, my goal was to take a complex backend architecture—involving Cashiers, Managers, and Admins—and 
              turn it into a cohesive, user-friendly web experience.
            </p>
...
export default POSProjectDetails;